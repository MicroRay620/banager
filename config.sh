...
# eval $(thefuck --alias) # Uncomment this if you have thefuck on your your system
# eval "$(pay-respects bash --alias)" # Uncomment this if you have pay-respects on your system
